...
public class FractalLogger {
     ...
     * @param mode
     */
    public static void logArgumentsGUI(DoubleProperty mandelbrotX, DoubleProperty mandelbrotY, DoubleProperty mandelbrotZoom, DoubleProperty power, IntegerProperty iteration,
     ...
     */
    public static void logDistributionArgumentsGUI(Property<RenderMode> mode, IntegerProperty tasksPerWorker, StringProperty connection) {
    ...
    public static void logSendPackageGUI(FractalRenderOptions options, int index, int total) {
        logger().debug(String.format("Sending a single package of type %s to the worker (%d/%d)", options.getType(), index, total));
